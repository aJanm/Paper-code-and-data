...
// PB5-> RCC_APB2Periph_GPIOB  
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA |RCC_APB2Periph_ADC1|RCC_APB2Periph_ADC2	, ENABLE );	 // //使能ADC1和2通道时钟
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AIN;		//模拟输入引脚,应用与adc电压采样输入
...
//  ADC_SampleTime_239Cycles5
  	...
  	ADC_RegularChannelConfig(ADC2, ADC_Channel_5, 1, ADC_SampleTime_239Cycles5 );	//ADC1,ADC通道,采样时间为239.5周期	 
