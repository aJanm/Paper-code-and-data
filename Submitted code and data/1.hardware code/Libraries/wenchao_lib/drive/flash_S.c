...
//================================================================================
//BY SAGAHDS 20190306
unsigned char FLASH_RDBUFF[256];     	//FLASH读缓存
unsigned char FLASH_WRBUFF[256];     	//FLASH写缓存
...
//读取指定页面0x0800F800的数据
void FLASH_ReadMoreCHAR(unsigned int startAddress, unsigned char *readData, unsigned int countToRead)	
{
	unsigned int i;
	unsigned int data;
...
void FLASH_WriteMoreCHAR(unsigned int startAddress, unsigned char *writeData, unsigned int countToWrite)	
{
	unsigned int i;
	unsigned long data;
	unsigned long FLASH_Address;
